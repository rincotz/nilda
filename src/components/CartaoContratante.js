...
import { capitalizeFirstLetter, getAge, getPeriodicity } from "../utils/utils";
      ...
      <Box display={"flex"} flexGrow={1}>
        ...
        >
          <Box display={"flex"} alignItems={"center"}>
            ...
            <Typography variant={"body2"}>
              {`${service.moradores} moradores`}
            </Typography>
          </Box>
          <Box display={"flex"} alignItems={"center"}>
            {getIcon(service.tipoDeHabitacao)}
            <Typography variant={"body2"}>
              {`${service.comodos} cômodos`}
            </Typography>
          </Box>
