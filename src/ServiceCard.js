      ...
      <div className={classes.detailsRow}>
        <CardContent>
          <div className={classes.detailsRow}>
            <Person />
            <Typography>
              {`${props.worker.nome.split(" ")[0]}, ${moment().diff(
                moment(props.worker.nascimentoDDMMAAAA, "DD-MM-YYYY"),
                "years"
              )}`}
            </Typography>
          </div>
          ...
          <div className={classes.detailsRow}>
            <MeetingRoom />
            <Typography>{props.worker.numeroDeComodos}</Typography>
          </div>
          <div className={classes.detailsRow}>
            {icone[props.worker.tipoDeHabitacao]}
            <Typography>{props.worker.bairro}</Typography>
          </div>
          <div className={classes.detailsRow}>
            <LocationOn />
            <Typography>{`${props.worker.distance} km`}</Typography>
          </div>
        </CardContent>
